...
const BootcampPagePreview = ({ entry, getAsset }) => {
  ...
  const overviewReasons = entryOverviewReasons
    ? entryOverviewReasons.toJS()
    : [];
  ...
  const entrySuitabilityobjectives = entry.getIn([
    "data",
    "admissions",
    "suitabilityobjectives",
  ]);
  const suitabilityobjectives = entrySuitabilityobjectives
    ? entrySuitabilityobjectives.toJS()
    : [];
    ...
    <BootcampPageTemplate
      ...
      overview={{
        ...
        testimonial: {
          ...
          image: getAsset(
            entry.getIn(["data", "overview", "testimonial", "image"])
          ),
          name: entry.getIn(["data", "overview", "testimonial", "name"]),
          position: entry.getIn([
            "data",
            "overview",
            "testimonial",
            "position",
      ...
      admissions={{
        ...
        steps,
        suitabilityheading: entry.getIn([
          "data",
          "admissions",
          "suitabilityhesding",
        ]),
        suitabilitysubheading: entry.getIn([
          "data",
          "admissions",
