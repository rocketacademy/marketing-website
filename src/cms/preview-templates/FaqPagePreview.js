...
const FaqPagePreview = ({ entry }) => {
  ...
  const generalQuestions = entryGeneralQuestions
    ? entryGeneralQuestions.toJS()
    : [];

  const entryCodingbasicsQuestions = entry.getIn([
    "data",
    "codingbasics",
    "questions",
  ]);
  const codingbasicsQuestions = entryCodingbasicsQuestions
    ? entryCodingbasicsQuestions.toJS()
    : [];

  const entrySoftwareengineeringbootcampQuestions = entry.getIn([
    "data",
    "softwareengineeringbootcamp",
    "questions",
  ]);
  const softwareengineeringbootcampQuestions =
    entrySoftwareengineeringbootcampQuestions
      ? entrySoftwareengineeringbootcampQuestions.toJS()
      : [];
