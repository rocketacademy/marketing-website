    ...
    <div>
      <Helmet>
        ...
        <link
          ...
          type="image/png"
          sizes="32x32"
          href="https://ra-web-files.s3.ap-southeast-1.amazonaws.com/all/brand/rocket-brand-32x32.png"
        />
        <link
          rel="icon"
          type="image/png"
          sizes="16x16"
          href="https://ra-web-files.s3.ap-southeast-1.amazonaws.com/all/brand/rocket-brand-16x16.png"
        />
        <link
          rel="mask-icon"
        ...
        <link
          rel="shortcut icon"
          href="https://ra-web-files.s3.ap-southeast-1.amazonaws.com/all/brand/rocket-brand-favicon.ico"
        />
        ...
        <meta
          ...
          content="Selective and comprehensive online Coding Bootcamp in Singapore, Hong Kong and Australia."
        />
        <meta
          property="og:image"
          content="https://ra-web-files.s3.ap-southeast-1.amazonaws.com/all/brand/sharing-logo.png"
        />
