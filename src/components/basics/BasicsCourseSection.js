...
const BasicsCourseSection = ({ lessons }) => {
  ...
  return (
    <div
      className="container basics-course-container section"
      id={lessons.sidebarlabel.replace(/ /g, "-").toLowerCase()}
    >
      <div className="basics-course-header">{lessons.heading}</div>
      <div className="basics-course-subheading">
        <MarkdownContent
          content={lessons.subheading}
          className={"basics-course-subheading"}
        />
      </div>
