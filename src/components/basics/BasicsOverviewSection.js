...
const BasicsOverviewSection = ({ overview }) => {
  return (
    <div
      className="container basics-overview-container section"
      id={overview.sidebarlabel.replace(/ /g, "-").toLowerCase()}
    >
      <h2 className="basics-overview-heading">{overview.heading}</h2>
      ...
      <div className="row basics-testimonial-row">
        ...
        <p className="basics-testimonial-quote">{overview.testimonial.quote}</p>
        <p className="basics-testimonial-name">{overview.testimonial.name}</p>
