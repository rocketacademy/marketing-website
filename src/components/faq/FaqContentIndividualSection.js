...
const FaqContentIndividualSection = ({ content }) => {
  ...
  return (
    <div
      className="faq-content-col-accordion section"
      id={content.sidebarlabel.replace(/ /g, "-").toLowerCase()}
    >
      <div className="faq-content-col-accordion-heading">{content.heading}</div>
      <Accordion flush>
