...
const BootcampCurriculumSection = ({ curriculum }) => {
  ...
  return (
    <div
      className="container bootcamp-curriculum-container section"
      id={curriculum.sidebarlabel.replace(/ /g, "-").toLowerCase()}
    >
      <h2 className="bootcamp-curriculum-heading">{curriculum.heading}</h2>
      <p className="bootcamp-curriculum-subheading">{curriculum.subheading}</p>
      <div className="row bootcamp-curriculum-row-desktop">
        {curriculum.sections.map((card, index) => {
          return (
            <div
              key={index}
              className="col-12 col-md-4 bootcamp-curriculum-card"
            >
      ...
      <div className="row bootcamp-curriculum-accordions-row">
        ...
        <div className="col-12 col-md-6 bootcamp-curriculum-accordions-col">
          {curriculum.modules1.map((module, index) => {
            return <BootcampCurriculumTopics module={module} index={index} />;
          })}
        </div>
        <div className="col-12 col-md-6 bootcamp-curriculum-accordions-col">
