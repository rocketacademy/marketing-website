...
const BootcampTuitionSection = ({ tuition }) => {
  return (
    <div
      className="container bootcamp-tuition-container section"
      id={tuition.sidebarlabel.replace(/ /g, "-").toLowerCase()}
    >
      <div className="bootcamp-tuition-heading">{tuition.heading}</div>
      <div className="bootcamp-tuition-subheading">{tuition.subheading}</div>
