...
const BootcampAdmissionsSection = ({ admissions }) => {
  return (
    <div
      className="container bootcamp-admissions-container section"
      id={admissions.sidebarlabel.replace(/ /g, "-").toLowerCase()}
    >
      <div className="bootcamp-admissions-header">{admissions.heading}</div>
      <MarkdownContent
        content={admissions.subheading}
        className={"bootcamp-admissions-subheading"}
      />
