...
const BootcampOverviewSection = ({ overview }) => {
  return (
    <div
      className="container bootcamp-overview-container section"
      id={overview.sidebarlabel.replace(/ /g, "-").toLowerCase()}
    >
      <h2 className="bootcamp-overview-heading">{overview.heading}</h2>
      <p className="bootcamp-overview-subheading">{overview.subheading}</p>
              ...
              <div className="bootcamp-overview-slide-container">
                <Card>
                  <Card.Body>
                    ...
                    <Card.Title>{reason.text}</Card.Title>
                  </Card.Body>
                </Card>
              </div>
            </div>
                ...
                <div className="bootcamp-overview-col">
                  <Card>
                    <Card.Body>
                      ...
                      <Card.Title>{reason.heading}</Card.Title>
                      <Card.Text>{reason.text}</Card.Text>
                    </Card.Body>
                  </Card>
                </div>
              </Carousel.Item>
      ...
      <div className="row bootcamp-testimonial-row">
        ...
        <p className="bootcamp-testimonial-name">{overview.testimonial.name}</p>
